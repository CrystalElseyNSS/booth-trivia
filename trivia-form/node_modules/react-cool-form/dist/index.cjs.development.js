...
var useState = (function (initialState, onChange) {
  ...
  var setStateRef = react.useCallback(function (path, value, _temp) {
    ...
    if (key === "values" || !lite.dequal(get(stateRef.current, path), value)) {
  ...
  var setUsedStateRef = react.useCallback(function (path) {
...
var useForm = (function (_ref) {
  ...
  var ignoreFieldsRef = react.useRef(arrayToMap(ignoreFields));
  ...
  var getFieldNames = react.useCallback(function () {
    return Object.keys(_extends__default['default']({}, fieldsRef.current, controllersRef.current));
  }, []);
  ...
  var setAllNodesOrStateValue = react.useCallback(function (values, checkDefaultValues) {
  ...
  var getState = react.useCallback(function (path, _temp) {
  ...
  var setFieldError = react.useCallback(function (name, error) {
  ...
  var validateFormWithLowPriority = react.useCallback(function () {
    return runWithLowPriority(validateForm);
  }, [validateForm]);
  var setFieldDirty = react.useCallback(function (name) {
  ...
  var setFieldTouched = react.useCallback(function (name, shouldValidate) {
  ...
  var setFieldTouchedMaybeValidate = react.useCallback(function (name) {
    return setFieldTouched(name, validateOnChange ? name !== changedFieldRef.current : undefined);
  }, [setFieldTouched, validateOnChange]);
  var setValues = react.useCallback(function (values, _temp2) {
  ...
  var setFieldValue = react.useCallback(function (name, value, _temp3) {
